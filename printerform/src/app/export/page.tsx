...
class PrintableFactory {
    ...
    img.onload = () => {
      ...
      const renderSide = (
        ...
        if (rendererContext) {
          ...
          // Calculate the x position to center the model horizontally
          const xPosition = (canvasWidth - modelWidth) / 2;
   ...
   public produceCurvedPrintable(loadingCallback: (percentComplete: number) => any, onComplete: (pdfDataUrl: string) => any) {
       ...
       img.onload = () => {
           ...
           // top model
           renderSide(0, true, false, 80, 50, 0.9);
           // bottom model
           renderSide(Math.PI, false, true, 80, 50, 0.9);
   ...
   public produceCurvedSideViewPrintable(loadingCallback: (percentComplete: number) => any, onComplete: (pdfDataUrl: string) => any) {
       ...
       img.onload = () => {
           ...
           // top model
           renderSide(Math.PI/2, true, false, 80, 360, 0.9);
           // bottom model
           renderSide(-Math.PI/2, false, true, 80, 360, 0.9);
...
const ALL_PROJECTIONS: ProjectionSelection[] = [
   ...
   },
   {
       ...
       previewThumbnailImgSrc: "curved_2.jpg",
       projectionDescription: "Side view of the model printed in a curved form",
       projectionTitle: "Curved Volume Form - Side View"
   }
