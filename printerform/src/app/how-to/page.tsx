      ...
      <div className="min-h-screen w-full bg-white p-40">
        ...
        <div className="mb-10 flex items-center space-x-6">
          <div>
            ...
            <p className="text-xl text-black">
              ...
              selection using the drop-down tools and sliders located on the
              right of your file preview.
            </p>
          </div>
          <div className="w-80 h-80 bg-gray-300 flex-shrink-0"></div>
        </div>
        ...
        <div className="mb-10 flex items-center space-x-6">
          <div>
            ...
            <p className="text-xl text-black">
              Using a standard inkjet or laser printer and 8.5” x 11” paper,
              print your saved PDF. Once you've printed out your PDF, use the
              dots and lines shown as instructions for how to fold the sheet
              into your 3D object. (Note that the locations of the lines and
              dots will change based on the size and shape of your file as well
              as the layout type you selected.)
            </p>
          </div>
          <div className="w-80 h-80 bg-gray-300 flex-shrink-0"></div>
        </div>
