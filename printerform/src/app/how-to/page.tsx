...
const HowTo = () => {
  return (
    <div className="min-h-screen w-full bg-white p-40">
      <h1 className="text-8xl font-bold mt-20 mb-10 text-center text-balance">
        Instructions
      </h1>
      ...
      <div className="mb-10 flex items-center space-x-6">
        ...
        <div>
          <h2 className="text-5xl mb-5">1. Upload</h2>
          <p className="text-xl">
      ...
      <div className="mb-10 flex items-center space-x-6">
        <div>
          <h2 className="text-5xl mb-5">2. Modify</h2>
          <p className="text-xl">
      ...
      <div className="mb-10 flex items-center space-x-6">
        <div className="w-80 h-80 bg-gray-300 flex-shrink-0"></div>
        <div>
          <h2 className="text-5xl mb-5">3. Download</h2>
          <p className="text-xl">
      ...
      <div className="mb-10 flex items-center space-x-6">
        <div>
          <h2 className="text-5xl mb-5">4. Print and Fold</h2>
          <p className="text-xl">
